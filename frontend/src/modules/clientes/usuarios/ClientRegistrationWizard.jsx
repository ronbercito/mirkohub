...
const CalendarPicker = ({ value, month, onMonthChange, onSelect }) => {
  ...
  return <div className="absolute z-40 left-0 top-full mt-2 w-72 rounded-xl border border-slate-700 bg-slate-900 p-3 shadow-2xl">
